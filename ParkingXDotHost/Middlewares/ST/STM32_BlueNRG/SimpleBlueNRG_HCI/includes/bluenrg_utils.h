...
/* Exported functions ------------------------------------------------------- */
/**
  * @brief  PNI version of Flash a new BLE firmware using internal bootloader.
  * @param  spiAddr   Start addr of the BLE image
  *         fw_size   Size of the firmware image. The firmware image size shall
